...
namespace
{
constexpr uart_inst_t *const DFPLAYER_UART = uart1;
constexpr uint DFPLAYER_TX_PIN = 4;  // Pico GPIO4 -> DFPlayer RX
constexpr uint DFPLAYER_RX_PIN = 5;  // Pico GPIO5 <- DFPlayer TX (optional)

constexpr uart_inst_t *const RFID_UART = uart0;
constexpr uint RFID_TX_PIN = 16;  // RDM6300 TX -> Pico RX (UART0)
constexpr uint RFID_RX_PIN = 17;  // Pico TX -> RDM6300 RX (often unused)
