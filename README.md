...
| RFID TX -> Pico | GPIO17 | Pin 22 | UART0 RX from RDM6300 TX (moved here to avoid conflict; level shift advised) |
| RFID RX <- Pico | GPIO16 | Pin 21 | UART0 TX to RDM6300 RX (often unused) |
...
**5V level note:** The RDM6300 TX line is 5V. Protect the Pico RX (GPIO17) with a resistor divider or level shifter.
...
- The RDM6300 TX pin outputs 5V logic. Use a level shifter or resistor divider before connecting to GPIO17.
